...
public class ArcMenu extends RelativeLayout {
    ...
    private boolean expandChild = true;
...
/*                	else if(!expandChild){
    ...
    // Shinhua create change child item size
	...
	private static Animation createHintSwitchAnimation(final boolean expanded) {
		 ...
		 */
		/*
		 * Animation animation = new RotateAnimation(expanded ? 15 : 0, expanded
		 * ? 0 : 15, Animation.RELATIVE_TO_SELF, 0.5f,
		 * Animation.RELATIVE_TO_SELF, 0.5f);
		 */

		// Maybe it needs new other object 
		Animation animation = new RotateAnimation(0, 0,
